    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requirement_uploads', to='accounts.request')),
                ('uploaded_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='uploads', to='accounts.studentaccount')),
            ],
            options={
                'ordering': ['-created_at'],
